...
const mobileHandLeft = document.querySelector(
  ".second-section__mobile-slider-button-left"
);
const mobileHandRight = document.querySelector(
  ".second-section__mobile-slider-button-right"
);
...
const replacementApartmentAreas = document.querySelectorAll(
  ".replacementApartmentArea"
);
const replacementRepairTimes = document.querySelectorAll(
  ".replacementRepairTime"
);

function switchSlide(index) {
  mobileImages.forEach((mobileImage) =>
    mobileImage.classList.remove("second-section__img-mobile--active")
  );
  images.forEach((image) =>
    image.classList.remove("second-section__img--active")
  );
  buttons.forEach((button) =>
    button.classList.remove("second-section__button--active")
  );
  listButtons.forEach((listButton) =>
    listButton.classList.remove("second-section__list-button--active")
  );
  replacementCitys.forEach((replacementCity) =>
    replacementCity.classList.remove("replacementCity--active")
  );
  replacementApartmentAreas.forEach((replacementApartmentArea) =>
    replacementApartmentArea.classList.remove(
      "replacementApartmentArea--active"
    )
  );
  replacementRepairTimes.forEach((replacementRepairTime) =>
    replacementRepairTime.classList.remove("replacementRepairTime--active")
  );
  ...
  replacementApartmentAreas[index].classList.add(
    "replacementApartmentArea--active"
  );
